...
const Newsletter = () => {
    ...
    return (
        <div className="newsletterWrapperB">
            <h2 className="newsletterTitleB">The Command Newsletter</h2>
            ...
            <iframe className="embeded" src="https://embeds.beehiiv.com/de9ab7fa-3e6f-4a25-a34d-36d163000b93?slim=true" data-test-id="beehiiv-embed" height="120" width="auto" frameBorder="0" scrolling="no"></iframe>
        </div>
    );
};
